image:https://github.com/HOME-programming-lab/kickstart/actions/workflows/maven.yml/badge.svg["CI Build", link="https://github.com/HOME-programming-lab/kickstart/actions"]
